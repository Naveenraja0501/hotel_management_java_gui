...
public class MainGUI2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Champ/dashboard_24.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Champ/room_24.png"))); // NOI18N
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Champ/customer_24.png"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Champ/employee_24.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Champ/admin_24.png"))); // NOI18N
        ...
        jLabel46.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Champ/info_24.png"))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Room Number", "Room Type", "Room Price (rs/night)", "Now Available"
            }
        ) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (!"".equals(jTextField10.getText().trim()) && !"".equals(jTextField13.getText().trim())) {
            try{
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hotel_management_system","root","naveen");
                String sql1;
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (!"".equals(jTextField12.getText().trim())) {
            try{
                Class.forName("com.mysql.cj.jdbc.Driver");
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hotel_management_system","root","Champ123@");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        if (!"".equals(jTextField1.getText().trim()))
            try{
                ...
                ResultSet rs = ptm1.executeQuery(sql1);
                if (rs.next()) {
                    jLabel72.setText("price - "+rs.getString("price")+"/- Rs/night");
                }
                else {
                    javax.swing.JOptionPane.showMessageDialog(null,"Room is already booked by other customer...\nOr room is not exist...");
                }
